# Blog Series Plan: Building [TOOL NAME] — An AI-Assisted Developer Journey
...
**Key Topics:**
- The itch that existing tools couldn't scratch
- A tour of what's already out there and where each fell short
- The moment the decision clicked: build vs. buy
- Introducing the AI assistant stack: Claude Code, Cursor, Codex, Junie
...
- CLAUDE.md: why this file matters and what goes in it
- Project settings, memory systems, and keeping context across sessions
- What a typical working session looks like with Claude Code
...
**Subtitle:** Claude Code, Cursor, Codex, and Junie walked into a bar. Here's who bought the first round.

**Key Topics:**
- Honest comparison of Claude Code, Cursor, Codex, and Junie for different task types
- When to reach for each tool: architecture vs. implementation vs. review
- How to avoid context-switching overhead
- Building a mental model for which AI to ask what
- Real examples from early [TOOL NAME] development

**LinkedIn Hook:** I'm using four different AI coding assistants on the same project — not because I couldn't pick one, but because each genuinely excels at different things.
...
- The feature itself: what it does and why it matters for [TOOL NAME]

**LinkedIn Hook:** I just shipped my first real feature on [TOOL NAME] — here's an honest breakdown of how AI assisted (and occasionally hindered) every phase of the build.
...
**Key Topics:**
- The bugs that AI introduced that I didn't catch immediately
...
- Updating CLAUDE.md and project memory based on hard lessons
...
**Key Topics:**
- Key architectural choices for [TOOL NAME]: what they were and why
...
## Post 7: Testing Strategy in an AI-First Workflow
...
- Current testing setup for [TOOL NAME]
...
## Post 8: Shipping Something Real — The First Release

**Subtitle:** From private repo to actual users — what it took and what I learned.

**Key Topics:**
- What "done" looks like for v0.1 of [TOOL NAME]
...
**LinkedIn Hook:** [TOOL NAME] just hit its first real release. Here's an honest retrospective on building with AI assistants from day one — what worked, what didn't, and what surprised me.

---

## Post 9 (Optional): The Meta-Layer — How AI Is Changing How I Think as a Developer
...
- What "developer judgment" means in 2025+
- How I explain this workflow to colleagues who are skeptical
- Recommendations for developers who want to build this way
...
## Post 10 (Optional): What I'd Tell Someone Starting This Journey Today
...
- What's next for [TOOL NAME] and this series
...
- **SEO titles to consider:** Phrases like "Claude Code CLAUDE.md", "AI coding assistant comparison", "building with Cursor and Claude", "AI-first developer workflow" have decent search volume.
